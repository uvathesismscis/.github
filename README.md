# ![Config](config_github_banner.png)

Configuration and dotfiles for the 'viszlab' GitHub organization as described in the [GitHub documentation](https://docs.github.com/en/organizations/collaborating-with-groups-in-organizations/customizing-your-organizations-profile#adding-a-member-only-organization-profile-readme). Includes files such as code of conduct and profile Readme's for the whole organization and sub repositories. Edit the markdown files in your favorite code editor or directly through the website using a browser.
